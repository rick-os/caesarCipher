...
```bash
# clone repo.
git clone https://github.com/rick-os/caesarCipher

cd ./caesarCipher

# compile with gcc or your compiler.
gcc main.c caesar_cipher.c -o caesar
...
### To Do:
- [ ] Create function to break encrypt.
- [ ] Add option to insert your own key.
- [ ] Change buffer flush method.
